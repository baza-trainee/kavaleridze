  ...
  content: [
    {
      ...
      images: [
        ...
        { imageLink: slider5, imageLabel: 'У музеї зберігається понад 5000 експонатів, присвячених життю і творчості майстра.' },
        {
          imageLink: slider6,
          imageLabel:
            'У музеї демонструються проекти пам‘ятників, станкові скульптури, які зображують Тараса Шевченка, Григорія Сковороду, Лесі Українки, Миколи Амосова та інших видатних людей.',
        },
    ...
    },
    {
      type: 'text',
      textContent:
        'Іван Кавалерідзе — видатна особистість, талановитий скульптур, великий кінорежисер і драматург. Він безумовно геній минулого століття. український Мікеланджело, як його називали. ',
      columns: 1,
    },
    {
      type: 'text',
