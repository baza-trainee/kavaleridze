  ...
  content: [
    {
      ...
      images: [
        ...
        },
        {
          imageLink: slider6,
          imageLabel:
            'У музеї демонструються проекти пам‘ятників, станкові скульптури, які зображують Тараса Шевченка, Григорія Сковороду, Лесю Українку, Миколи Амосова та інших видатних людей.',
        },
